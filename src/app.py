...
if selected == "Geologico":
    ...
    line1 = mpatches.Patch(color='#30123b', label='>5cm Est')
    line2 = mpatches.Patch(color='#4455c4', label='4-5cm Est')
    line3 = mpatches.Patch(color='#4390fe', label='3-4cm Est')
    line4 = mpatches.Patch(color='#1fc9dd', label='2-3cm Est')
    line5 = mpatches.Patch(color='#2aefa1', label='1-2cm Est')
    line6 = mpatches.Patch(color='#7eff55', label='0-1cm Est')
    line7 = mpatches.Patch(color='#c2f234', label='0-1cm Ovest')
    line8 = mpatches.Patch(color='#f2c93a', label='1-2cm Ovest')
    line9 = mpatches.Patch(color='#fe8f29', label='2-3cm Ovest')
    line10 = mpatches.Patch(color='#e94d0d', label='3-4cm Ovest')
    line11 = mpatches.Patch(color='#bd2002', label='4-5cm Ovest')
    line12 = mpatches.Patch(color='#7a0403', label='>5cm Ovest')
