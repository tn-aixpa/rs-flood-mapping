...
## python main.py "{'s1PreFlood':'sentinel1_GRD_preflood','s1PostFlood':'sentinel1_GRD_postflood','s2PreFlood':'sentinel2_pre_flood','s2PostFlood':'sentinel2_post_flood','geomWKT':'POLYGON ((10.81356293600004 46.09024746800003, 10.81356293600004 46.56319437500008, 11.285659684000052 46.56319437500008, 11.285659684000052 46.09024746800003, 10.81356293600004 46.09024746800003))','aoi_name':'Val di NON','slopeArtifact':'Slopes_TN','slopeFileName':'trentino_slope_map.tif','lakeShapeArtifactName':'Lakes_TN','lakeShapeFileName':'idrspacq.shp','riverShapeArtifactName':'Rivers_TN','riverShapeFileName':'cif_pta2022_v.shp','output':'val_di_non_2018','eventDate':'2018-10-27','targetCRS':'EPSG:25832','polarization':['VV','VH'],'dem_threshold':600,'slope_threshold':7,'noise_min_pixels':7,'river_buffer_meters':1, 'aoi_name':'Val di NON'}"
    ...
    for dirname, subdirs, files in os.walk(output_folder):
        for filename in files:
            if(filename.endswith('.tif') or
                ...
                filename.endswith('.shp') or
                filename.endswith('.shx') or
                filename.endswith('.dbf') or   
                filename.endswith('.prj') or
