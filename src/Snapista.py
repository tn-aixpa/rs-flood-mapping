...
import shapefile
from config import S1_ZIP_PATH, SHAPEFILE_PATH, OUTPUT_FOLDER
...
output_file = os.path.join(OUTPUT_FOLDER, "flood_mask")
run_pipeline_zip(S1_ZIP_PATH, SHAPEFILE_PATH, output_file)
